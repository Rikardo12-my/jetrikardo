...
<head>
    ...
    <title>Form Penginputan Data Mahasiswa</title>
</head>
<body class="bg-secondary text-dark">
    <h1 class="text-center mt-1 "><i>Penginputan Data Mahasiswa</i></h1>
    <hr class="mb-0">
     <form action="save.php" method="post" class="mt-0" enctype="multipart/form-data">
   
        <div >
            <label for="disabledTextInput" class="form-label" >Nim</label>
            <input type="text" id="disabledTextInput" name="nim" class="form-control" placeholder="Input Nidn">
        </div>
        <div>
       ...
       <div>
        ...
        <div>
            ...
            <input type="text" id="disabledTextInput" name="ponsel" class="form-control" placeholder="Input Nomor">
        </div>
        <div>
            <label for="disabledTextInput" class="form-label">Foto</label>
            <input type="file" id="disabledTextInput" name="foto" id="" class="form-control" placeholder="Input Foto"> <br>
        </div>
